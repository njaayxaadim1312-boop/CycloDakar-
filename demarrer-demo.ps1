...
Ecrire '    chef@cyclodakar.sn       chef de groupe : planifie les sorties,'
Ecrire '                             AUCUN acces a l argent'
Ecrire '    collecteur@cyclodakar.sn encaisse ses membres assignes'
