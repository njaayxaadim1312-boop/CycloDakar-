...
/**
 * Formatage d'affichage (mobile).
 *
 * Copie volontaire de `web/src/lib/format.ts` : les deux plateformes ne
 * partagent pas de paquet commun (ADR-006). Toute correction ici doit être
 * reportée dans le fichier web, et réciproquement.
 *
